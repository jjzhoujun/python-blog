...
'''''
CSDN博客抓取， 不能频繁抓，需要sleep,不然封IP
@author zhoujun
@date 2017-06-25
@refer 参考 http://blog.csdn.net/yazhi1992/article/details/51756328
'''''
...
class Scheduler:
    ...
    def start(self):
        ...
        # query_list = [{'blogurl', '123123'}, {'blogurl', '123123'}, {'blogurl', '123123'},
        #               {'blogurl', '123123'}, {'blogurl', '123123'}, {'blogurl', '123123'}]
        url_length = 1
        url_num = 0
        while True:
            if url_num < url_length:
                # now_url = query_list[url_num].get('blogurl')
                now_url = "http://blog.csdn.net/jjzhoujun2010/article/details/49521627"
